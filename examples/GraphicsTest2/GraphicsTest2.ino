...
#include <Waveshare_ILI9486.h> // adapted fro Arduino-Pro
...
namespace
{
	Waveshare_ILI9486 Waveshield; // change your setting for SPI interface in the library Waveshare_ILI9486.h .cpp
